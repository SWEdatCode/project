<html>
	...
	<body>
		...
		<a href="website1.php">Click here to go back</a><br/><br/>
...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	{
		mysqli_query("INSERT INTO users (username, password) VALUES ('$username','$password')"); //Inserts the value to table users
